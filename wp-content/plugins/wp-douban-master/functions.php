...
function display_book_detail($id) {
    ...
    $output = '<div class="doulist-item"><div class="mod"><div class="v-overflowHidden doulist-subject"><div class="post"><img width="100px" src="' . wpd_save_images($id, $data['images']['small']) . '" ></div>';
    $output.= '<div class="title"><a href="' . $data["alt"] . '" class="cute" target="_blank" rel="external nofollow">' . $data["title"] . '</a></div>';
