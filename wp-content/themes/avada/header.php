...
<body <?php body_class(); ?>>
	...
	<div id="wrapper" class="<?php echo esc_attr( $wrapper_class ); ?>">
		...
		<?php endif; ?>
        <?php if(is_page_template('contact.php')&& Avada()->settings->get('bmap_lon') && Avada()->settings->get('bmap_lan')): ?>
	<?php
		echo do_shortcode('[baidu_map id="abcd" w="' . Avada()->settings->get('bmap_width') . '" h="' . Avada()->settings->get('bmap_height') . '" lon="' . Avada()->settings->get('bmap_lon') . '" lat="' . Avada()->settings->get('bmap_lan') . '" biz_name="' . Avada()->settings->get('bmap_company') . '" address="' . Avada()->settings->get('bmap_address') . '" email="' . Avada()->settings->get('bmap_email') . '" phone="' . Avada()->settings->get('bmap_tel') . '"]');
	?>
	<?php endif; ?>
