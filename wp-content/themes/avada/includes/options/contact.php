...
function avada_options_section_contact( $sections ) {
	...
	$sections['contact'] = array(
		...
		'fields'   => array(
		    ...
		    'baidu_map_section' => array(
				'label'       => esc_html__( 'Baidu Map', 'Avada' ),
				'description' => '',
				'id'          => 'baidu_map_section',
				'default'     => esc_html__( 'Baidu Map', 'Avada' ),
				'icon'        => true,
				'type'        => 'sub-section',
				'fields'      => array(
					
					'bmap_width' => array(
						'label'           => esc_html__( 'Bmap Width', 'Avada' ),
						'description'     => esc_html__( 'Please input map width.', 'Avada' ),
						'id'              => 'bmap_width',
						'default'         => '',
						'type'            => 'text',
						'active_callback' => array( 'Avada_Options_Conditionals', 'is_contact' ),
					...
					'bmap_height' => array(
						'label'           => esc_html__( 'Bmap Height', 'Avada' ),
						'description'     => esc_html__( 'Please input map height.', 'Avada' ),
						'id'              => 'bmap_height',
						'default'         => '',
						'type'            => 'text',
						'active_callback' => array( 'Avada_Options_Conditionals', 'is_contact' ),
					...
					'bmap_lon' => array(
						'label'           => esc_html__( 'Bmap Lon', 'Avada' ),
						'description'     => esc_html__( 'Please input map lon.', 'Avada' ),
						'id'              => 'bmap_lon',
						'default'         => '',
						'type'            => 'text',
						'active_callback' => array( 'Avada_Options_Conditionals', 'is_contact' ),
					...
					'bmap_lan' => array(
						'label'           => esc_html__( 'Bmap Lat', 'Avada' ),
						'description'     => esc_html__( 'Please input map lat.', 'Avada' ),
						'id'              => 'bmap_lan',
						'default'         => '',
						'type'            => 'text',
						'active_callback' => array( 'Avada_Options_Conditionals', 'is_contact' ),
					...
					'bmap_company' => array(
						'label'           => esc_html__( 'Company name', 'Avada' ),
						'description'     => esc_html__( 'Please input company name.', 'Avada' ),
						'id'              => 'bmap_company',
						'default'         => '',
						'type'            => 'text',
						'active_callback' => array( 'Avada_Options_Conditionals', 'is_contact' ),
					...
					'bmap_address' => array(
						'label'           => esc_html__( 'Company Address', 'Avada' ),
						'description'     => esc_html__( 'Please input company address.', 'Avada' ),
						'id'              => 'bmap_address',
						'default'         => '',
						'type'            => 'text',
						'active_callback' => array( 'Avada_Options_Conditionals', 'is_contact' ),
					...
					'bmap_email' => array(
						'label'           => esc_html__( 'Company email', 'Avada' ),
						'description'     => esc_html__( 'Please input company email.', 'Avada' ),
						'id'              => 'bmap_email',
						'default'         => '',
						'type'            => 'text',
						'active_callback' => array( 'Avada_Options_Conditionals', 'is_contact' ),
					...
					'bmap_tel' => array(
						'label'           => esc_html__( 'Company phone', 'Avada' ),
						'description'     => esc_html__( 'Please input company phone.', 'Avada' ),
						'id'              => 'bmap_tel',
						'default'         => '',
						'type'            => 'text',
						'active_callback' => array( 'Avada_Options_Conditionals', 'is_contact' ),
