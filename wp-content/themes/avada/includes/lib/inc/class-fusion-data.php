...
class Fusion_Data {
	...
	public static function fusion_social_icons( $custom = true, $colors = false ) {
		...
		$networks = array(
		    'weibo'    => array( 'label' => '新浪微博',    'color' => '#ff6060' ),
			'tqq'    => array( 'label' => '腾讯微博',    'color' => '#348fde' ),
			'renren'    => array( 'label' => '人人网',    'color' => '#337ac5' ),
			'baidu'    => array( 'label' => '百度空间',    'color' => '#2aa7df' ),
			'weixin'    => array( 'label' => '微信',    'color' => '#4ac22d' ),
			'qq'    => array( 'label' => 'QQ',    'color' => '#116abc' ),
			'blogger'    => array(
				'label' => 'Blogger',
				'color' => '#f57d00',
			),
