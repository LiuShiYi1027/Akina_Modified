...
class Fusion_Widget_Social_Links extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'social_links-widget', 'Avada: 社交链接', $widget_ops, $control_ops );
	}
			...
			<div class="fusion-social-networks-wrapper">
				...
				<?php foreach ( $social_networks_ordered as $name => $value ) : ?>
					...
					if ( is_string( $value ) ) {
						...
						$tooltip = ( $tooltip === 'weibo' ) ? '新浪微博' : $tooltip;
						$tooltip = ( $tooltip === 'weixin' ) ? '微信' : $tooltip;
						$tooltip = ( $tooltip === 'renren' ) ? '人人网' : $tooltip;
						$tooltip = ( $tooltip === 'baidu' ) ? '百度空间' : $tooltip;
						$tooltip = ( $tooltip === 'tqq' ) ? '腾讯微博' : $tooltip;
						$tooltip = ( $tooltip === 'qq' ) ? 'QQ' : $tooltip;
					} else {
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['fb_link']            = isset( $new_instance['fb_link'] ) ? $new_instance['fb_link'] : '';
                	$instance['weibo_link']            = isset($new_instance['weibo_link']) ?$new_instance['weibo_link'] : '';
		$instance['tqq_link']        = isset($new_instance['tqq_link']) ?$new_instance['tqq_link'] : '';
		$instance['renren_link']           = isset($new_instance['renren_link']) ?$new_instance['renren_link'] : '';
		$instance['weixin_link']       = isset($new_instance['weixin_link']) ?$new_instance['weixin_link'] : '';
		$instance['qq_link']         = isset($new_instance['qq_link']) ?$new_instance['qq_link'] : '';
		$instance['baidu_link']       = isset($new_instance['baidu_link']) ?$new_instance['baidu_link'] : '';
