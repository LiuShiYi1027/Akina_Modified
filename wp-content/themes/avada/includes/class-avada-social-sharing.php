...
class Avada_Social_Sharing extends Avada_Social_Icon {
	...
	public function get_authorpage_social_links_array( $args ) {
		...
		if ( get_the_author_meta( 'author_weibo', $args['author_id'] ) ) {
			$social_links_array['weibo'] = array(
				'url'        => get_the_author_meta( 'author_weibo', $args['author_id'] ),
			);
		}

		if ( get_the_author_meta( 'author_tqq', $args['author_id'] ) ) {
			$social_links_array['tqq'] = array(
				'url'        => get_the_author_meta( 'author_tqq', $args['author_id'] ),
			);
		}

		if ( get_the_author_meta( 'author_renren', $args['author_id'] ) ) {
			$social_links_array['renren'] = array(
				'url'        => get_the_author_meta( 'author_renren', $args['author_id'] ),
			);
		}

		if ( get_the_author_meta( 'author_qq', $args['author_id'] ) ) {
			$social_links_array['qq'] = array(
				'url'        => get_the_author_meta( 'author_qq', $args['author_id'] ),
			);
		}

		if ( get_the_author_meta( 'author_baidu', $args['author_id'] ) ) {
			$social_links_array['baidu'] = array(
				'url'        => get_the_author_meta( 'author_baidu', $args['author_id'] ),
			);
		}

		if ( get_the_author_meta( 'weixin', $args['author_id'] ) ) {
			$social_links_array['weixin'] = array(
				'url'        => get_the_author_meta( 'weixin', $args['author_id'] ),
			);
		}
